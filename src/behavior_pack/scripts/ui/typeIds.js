/*
 * Vanilla item/block typeId -> numeric ID maps used to compute the aux value
 * for the JSON UI item renderer (aux = ID * 65536).
 *
 * Vendored unmodified from Chest-UI (https://github.com/Herobrine643928/Chest-UI)
 * by LeGend077 & Herobrine64, licensed CC BY 4.0. Update this file from
 * upstream when new Minecraft versions add items.
 */
